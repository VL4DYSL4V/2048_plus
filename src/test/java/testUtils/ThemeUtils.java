...
public final class ThemeUtils {
    ...
    public static Theme getRandomTheme(){
        ...
        Font font = new Font(Font.SANS_SERIF, Font.BOLD, random.nextInt(20));
        Image image = new BufferedImage(random.nextInt(100), random.nextInt(100), BufferedImage.TYPE_3BYTE_BGR);
